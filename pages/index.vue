  ...
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      <div class="text-xs-center">
        <img src="/signal-white.png" alt="Vuetify.js" class="my-5" height="80" />
      </div>
      <v-card>
        <v-card-title class="headline">Welcome to the Signal Management portal</v-card-title>
        <v-card-text>
        ...
        <v-card-actions>
          ...
          <v-btn color="primary" nuxt to="/maintenance">Maintenance Request</v-btn>
        </v-card-actions>
      </v-card>
    </v-flex>
  </v-layout>
